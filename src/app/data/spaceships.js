...
export const spaceships = [
    ...
    },
    {
      ...
      "category": "Starfighter",
      "description": "O TIE Fighter é a nave padrão da frota imperial, caracterizada por seu design ameaçador com asas hexagonais e sua impressionante capacidade de manobra. Embora sua construção simples não seja voltada para resistência, sua agilidade e velocidade excepcionais a tornam ideal para confrontos rápidos e ataques surpresa. A falta de sistemas de escudos e blindagem é compensada pela sua alta taxa de aceleração e impressionante precisão, tornando-a uma presença temida nos campos de batalha espaciais.",
      "imageUrl": "/images/TIE_Fighter_DICE.webp"
    },
    {
      "id": 3,
      ...
      "category": "Freighter",
      "description": "A Millennium Falcon é uma das naves mais emblemáticas da galáxia, famosa tanto por sua aparência improvisada quanto por seu desempenho extraordinário. Originalmente uma nave de carga modificada, ela passou a ser uma das mais rápidas da galáxia devido a modificações extensivas em seus motores e sistemas de navegação. Suportada por uma tripulação improvável, composta por Han Solo e Chewbacca, a Falcon resistiu a inúmeras batalhas e escapou de situações aparentemente impossíveis, tornando-se um símbolo de coragem e engenhosidade.",
      "imageUrl": "/images/Millennium_Falcon_Fathead_TROS.webp"
    },
    {
      "id": 4,
    ...
    },
    {
      ...
      "description": "O Imperial I-class Star Destroyer é uma das naves de guerra mais imponentes do Império Galáctico, projetada para esmagar qualquer resistência com sua força massiva. Com uma impressionante quantidade de armamento, incluindo canhões de laser pesados e vastos hangares para TIE Fighters, ele também tem capacidade para transportar tropas e veículos de combate, o que o transforma em uma verdadeira fortaleza móvel. Seu tamanho colossal e poder de fogo fazem dele um símbolo do domínio do Império sobre a galáxia.",
      "imageUrl": "/images/ImperialStarDestroyer-RFGE.webp"
    },
    {
      "id": 6,
      "name": "Slave I",
      ...
      "description": "A Slave I é a nave icônica de Boba Fett, projetada para ser uma máquina de guerra tanto no espaço quanto no combate terrestre. Com seu design incomum e sua estrutura altamente modificada, é uma nave de patrulha e ataque extremamente eficaz. Equipado com um arsenal impressionante de armamentos avançados, incluindo lasers pesados, mísseis e outros dispositivos especializados, a Slave I é tanto uma ferramenta de caça implacável quanto um símbolo de medo e respeito no universo de caçadores de recompensas.",
      "imageUrl": "/images/Slave_I_DICE.webp"
    },
    {
      "id": 7,
      "name": "Y-Wing",
